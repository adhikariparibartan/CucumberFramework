...
@Given("^user open to \"([^\"]*)\"$")
public void user_open_to(String arg1)  {
    driver.get(arg1);
}
...
public void user_enters_your_name_as(String arg1) {
driver.findElement(By.name("name")).sendKeys("Dibash");


}
@When("^user enter  your email as \"([^\"]*)\"$")
public void user_enter_your_email_as(String arg1) throws Throwable {
   driver.findElement(By.name("email")).sendKeys("sapkotadibash@gmail.com");
}
